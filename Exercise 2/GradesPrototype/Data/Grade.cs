...
namespace GradesPrototype.Data
{
    ...
    public abstract class User
    {
        ...
        public string Password
        {
            set
            {
                ...
                {
                    throw new ArgumentException("The password could not be set.", "Password");
                }
            }
        }
    ...
    public class Student: User, IComparable<Student>
    {
        ...
        {
            if (pwd.Length >= 6)        //If the password that is being set is 6 characters or longer, it'll be succesfully set and _password will take over the new value. Otherwise it'll throw an exception in the User class.
            {
                _password = pwd;
                return true;
            }
    ...
    public class Teacher : User
    {
        ...
        public override bool SetPassword(string pwd)
        {
            Match numericMatch = Regex.Match(pwd, @".*[0-9]+.*[0-9]+.*");       //Checks if the password has at least 2 numeric characters.

            //If the password that is being set is 8 characters or longer and it contains at least 2 numeric characters, it'll be succesfully set and _password will take over the new value. Otherwise it'll throw an exception in the User class.
